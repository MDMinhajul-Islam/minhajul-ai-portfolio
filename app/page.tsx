...
const career = [
  ['2019—2024', 'CSE Graduate', 'North South University', 'Software engineering, machine learning, deep learning, and computer vision foundations.', 'COMPLETED'],
  ['2023—2024', 'Applied AI Research', 'Senior Design + Directed Research', 'Lightweight diffusion, image inpainting, object removal, and evidence-led evaluation.', 'COMPLETED'],
  ['2024—2025', 'Research Intern', 'Image Segmentation & Object Removal', 'Advanced a multi-stage computer-vision pipeline from failure analysis to reproducible results.', 'COMPLETED'],
  ['NOW', 'AI Engineer Intern', 'NEXVIX', 'Engineering AI capabilities and dependable software workflows for real product use.', 'CURRENT'],
