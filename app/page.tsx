...
const career = [
  ['2020', 'College Completed', 'Academic foundation', 'Completed college in 2020; the COVID-19 result delay postponed the university admission timeline.', 'COMPLETED'],
