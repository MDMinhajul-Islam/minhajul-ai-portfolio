...
const projects = [
  ...
  { index: '09', title: 'NexGen Lifestyle', type: 'E-COMMERCE / AI RETAIL', summary: 'Brings fashion shopping and customer support into one AI-assisted retail experience. A React storefront connects to tools for product search, comparison, stock checks, order tracking, and return eligibility.', proof: 'FastAPI + Supabase tool gateway with typed requests, policy retrieval, audit logs, and confirmation checks for order changes—keeping database credentials out of the AI layer.', metrics: ['React', 'FastAPI', 'Supabase'], href: 'https://github.com/MDMinhajul-Islam/Clothing-Lifestyle', color: '#f59ecf' },
];
